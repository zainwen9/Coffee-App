             ...
             child: Column(
               ...
               children: [
                 ...
                 child: Column(
                   crossAxisAlignment: CrossAxisAlignment.start,
                   children: [
                     Text("BEST COFFEE",style: TextStyle(color: Colors.white.withOpacity(0.5),
                     letterSpacing: 3,
                     ),
                     ),
                     SizedBox(height: 20,),
                     ...
                     SizedBox(height: 20,),
                     Text("Coffee is a mjor source of antioxidants in the diet. It has health benefits",style: TextStyle(
                       color: Colors.white.withOpacity(0.4),fontSize: 16,fontWeight: FontWeight.w500,
                     ),),
                     SizedBox(height: 20,),
                     Row(
                       children: [
